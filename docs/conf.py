# -*- coding: utf-8 -*-
#
# OATH Toolkit Python Bindings documentation build configuration file, created
# by sphinx-quickstart on Fri Jun 21 19:06:46 2013.
#
...
version = re.match(r'\d+\.\d+', oath_toolkit.__version__).group(0)
# The full version, including alpha/beta/rc tags.
release = oath_toolkit.__version__
...
htmlhelp_basename = 'OATHToolkitPythonBindingsdoc'
...
latex_elements = {
    ...
    'preamble': r'\usepackage[mathletters]{ucs}',
}
...
man_pages = [
    ('index', 'pyoath-toolkit', LONG_TITLE, [AUTHORS], 1)
]
